...
<?php
    ...
    <br><br>
    <div class="container">
    <div class="col-md-offset-4 col-sm-offset-4 col-sm-4 col-md-4" style="position:absolute; top:180px; left:500px;">
                ...
                if (mysqli_num_rows($query_run)>0) {
                    foreach($query_run as $tarjeta){
                        ...
                        <tr>
                            ...
                            <a class="btn btn-success"  href="DesRSA.php?id=<?= $tarjeta['id']; ?>"><i >Ver</i></a>
                                                                        -->
